...
public class ShowLocksRequest implements org.apache.thrift.TBase<ShowLocksRequest, ShowLocksRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ShowLocksRequest> {
  ...
  public ShowLocksRequest setDbname(String dbname) {
    this.dbname = dbname;
    return this;
  }
  ...
  public ShowLocksRequest setTablename(String tablename) {
  ...
  public ShowLocksRequest setPartname(String partname) {
