...
public class PutFileMetadataRequest implements org.apache.thrift.TBase<PutFileMetadataRequest, PutFileMetadataRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PutFileMetadataRequest> {
  ...
  public List<Long> fileIds; // required
  public List<ByteBuffer> metadata; // required
  /**
   * 
   * @see FileMetadataExprType
   */
  public FileMetadataExprType type; // optional
  ...
  public PutFileMetadataRequest setFileIds(List<Long> fileIds) {
    this.fileIds = fileIds;
    return this;
  }
  ...
  public PutFileMetadataRequest setMetadata(List<ByteBuffer> metadata) {
    this.metadata = metadata;
    return this;
  }
   ...
   * @see FileMetadataExprType
   */
  public PutFileMetadataRequest setType(FileMetadataExprType type) {
    this.type = type;
    return this;
  }
