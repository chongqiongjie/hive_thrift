...
public class SQLForeignKey implements org.apache.thrift.TBase<SQLForeignKey, SQLForeignKey._Fields>, java.io.Serializable, Cloneable, Comparable<SQLForeignKey> {
  ...
  public String pktable_db; // required
  public String pktable_name; // required
  public String pkcolumn_name; // required
  public String fktable_db; // required
  public String fktable_name; // required
  public String fkcolumn_name; // required
  public int key_seq; // required
  public int update_rule; // required
  public int delete_rule; // required
  public String fk_name; // required
  public String pk_name; // required
  ...
  public SQLForeignKey setPktable_db(String pktable_db) {
    this.pktable_db = pktable_db;
    return this;
  }
  ...
  public SQLForeignKey setPktable_name(String pktable_name) {
    this.pktable_name = pktable_name;
    return this;
  }
  ...
  public SQLForeignKey setPkcolumn_name(String pkcolumn_name) {
    this.pkcolumn_name = pkcolumn_name;
    return this;
  }
  ...
  public SQLForeignKey setFktable_db(String fktable_db) {
    this.fktable_db = fktable_db;
    return this;
  }
  ...
  public SQLForeignKey setFktable_name(String fktable_name) {
    this.fktable_name = fktable_name;
    return this;
  }
  ...
  public SQLForeignKey setFkcolumn_name(String fkcolumn_name) {
    this.fkcolumn_name = fkcolumn_name;
    return this;
  }
  ...
  public SQLForeignKey setFk_name(String fk_name) {
    this.fk_name = fk_name;
    return this;
  }
  ...
  public SQLForeignKey setPk_name(String pk_name) {
    this.pk_name = pk_name;
    return this;
  }
