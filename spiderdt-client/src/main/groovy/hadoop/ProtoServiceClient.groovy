...
class ProtoServiceClient {
    ...
    static refreshHadoopClient(_hadoopClient) {
        def args = _hadoopClient.args
        if(!_hadoopClient.socket.connected) {
            System.out.println("reconnecting...")
            _hadoopClient.putAll(openHadoopClient(args.hostname, args.port, args.username, args.password))
        }
        _hadoopClient
    }
   static getListing(_hdfsClient, src, startAfter = "", needLocation = false) {
        def hdfsClient = refreshHadoopClient(_hdfsClient)
